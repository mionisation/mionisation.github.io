...
(function($){
	$.fn.crossword = function(entryData) {
			...
			*/
			...
			this.after('<div id="puzzle-clues"><h1>Instructions: Solve the crossword. </h1> <h1>(Click on hints, then type)</h1> <h2>Across</h2><ol id="across"></ol><h2>Down</h2><ol id="down"></ol></div>');
